...
var ProjectsCtrl = (function () {
    function ProjectsCtrl($scope, $state, SignalRSrv, ModalService, growl) {
        //$scope.state = $state;
        $scope.projects = {};
        // SignalR Setup
        ...
        this.editProjectModal = function (project) {
            this.showAModal(project, "Client/Pages/Projects/EditProjectModal.html", "GenericYesNoModalCtrl", function (result) {
                if (!result.cancel) {
                    // Any file uploads?
        ...
        this.addProjectModal = function () {
            this.showAModal(new Project(-1, "", "", "New Project", 0, "Description", true, Level.INTRODUCTION), "Client/Pages/Projects/AddProjectModal.html", "GenericYesNoModalCtrl", function (result) {
                if (!result.cancel) {
                    // Any file uploads?
                    // Upload Judge instructions
        ...
        this.deleteProjectModal = function (project) {
            this.showAModal(project, "Client/Pages/Projects/DeleteProjectModal.html", "GenericYesNoModalCtrl", function (result) {
                if (!result.cancel) {
                    // Any file uploads?
                    // Upload Judge instructions
                    if (result.uploadme1.src != "") {
    ...
    ;
    ProjectsCtrl.prototype.base64ToHex = function (str) {
    ...
    ProjectsCtrl.prototype.downloadFile = function (name, data) {
