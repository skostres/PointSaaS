...
namespace SignalrWebService.Performance
{
    public class PerformanceEngine
    {
        ...
        static PerformanceCounter _cpuRand;
        static PerformanceCounter _memRand;
        ...
        public PerformanceEngine(int pollIntervalMillis)
        {
            ...
            _cpuRand = new PerformanceCounter("Processor Information", "% Processor Time", "_Total");
            _memRand = new PerformanceCounter("Memory", "Available MBytes");
            _netIn = new Random();
            _netOut = new Random();
            _diskRd = new Random();
            _diskWt = new Random();
        ...
        public async Task OnPerformanceMonitor()
        {
            ...
            {
                new PerformanceModel() { CategoryName="Processor", Value=(int)_cpuRand.NextValue(), CounterName="% Processor Time", InstanceName=".", MachineName="SitePointService"},
                new PerformanceModel() { CategoryName="Memory", Value=(int)_memRand.NextValue(), CounterName="Available MBytes", InstanceName=".", MachineName="SitePointService"},
